...
CD3D9Enumeration::CD3D9Enumeration()
{
    ...
    m_nMinWidth = WINSIZEX;
    m_nMinHeight = WINSIZEY;
                                         ...
                                         DXUTMatchOptions* pMatchOptions )
{
    ...
    if( pMatchOptions->eResolution == DXUTMT_IGNORE_INPUT )
    {
        ...
        {
            pOptimalDeviceSettings->pp.BackBufferWidth = WINSIZEX;
            pOptimalDeviceSettings->pp.BackBufferHeight = WINSIZEY;
        }
        else
        {
            pD3D->GetAdapterDisplayMode( pOptimalDeviceSettings->AdapterOrdinal, &adapterDesktopDisplayMode );
    ...
    else
    {
        ...
        else // if( pMatchOptions->eResolution == DXUTMT_IGNORE_INPUT )   
        {
            if( pBestDeviceSettingsCombo->Windowed )
            {
                ...
                displayModeIn.Width = WINSIZEX;
                displayModeIn.Height = WINSIZEY;
            }
            else
            {
                                          ...
                                          DXUTMatchOptions* pMatchOptions )
{
    ...
    DXGI_MODE_DESC adapterDesktopDisplayMode = { WINSIZEX, WINSIZEY, { 0, 0 }, DXGI_FORMAT_R8G8B8A8_UNORM_SRGB };
    ...
    if( pMatchOptions->eResolution == DXUTMT_IGNORE_INPUT )
    {
        ...
        {
            pOptimalDeviceSettings->sd.BufferDesc.Width = WINSIZEX;
            pOptimalDeviceSettings->sd.BufferDesc.Height = WINSIZEY;
        }
        else
        {
...
HRESULT WINAPI DXUTGetD3D10AdapterDisplayMode( UINT AdapterOrdinal, UINT nOutput, DXGI_MODE_DESC* pModeDesc )
{
    ...
    if( pOutputInfo )
    {
        pModeDesc->Width = WINSIZEX;
        pModeDesc->Height = WINSIZEY;
